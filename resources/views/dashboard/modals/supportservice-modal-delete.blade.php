<div class="modal fade" id="delete-{{$service->id}}" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content bg-primary text-white">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{route("supportservices.destroy", $service->id)}}">
                    @csrf
                    @method("DELETE")
