<div class="modal fade" id="delete-{{$profesionalDev->id}}" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content bg-primary text-white">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{route("profesionaldev.destroy", $profesionalDev->id)}}">
                    @csrf
                    @method("DELETE")
