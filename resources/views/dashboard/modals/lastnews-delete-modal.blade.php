<div class="modal fade" id="delete-{{$lastestNew->id}}" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content bg-primary text-white">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{route("lastnews.destroy", $lastestNew->id)}}">
                    @csrf
                    @method("DELETE")
