<div class="modal fade" id="delete-{{$homeSection->id}}" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content bg-primary text-white">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{route("homesections.destroy", $homeSection->id)}}">
                    @csrf
                    @method("DELETE")
