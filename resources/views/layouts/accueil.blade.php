...
<body>
    @if(isset($banners->file))

    <header style="background: url(' {{asset('storage/banners/'.$banners->file)}}') center center/cover;">
        <!-- Navigation  -->
    ...
    @else
    <header style="background: url(' {{asset('assets/img/hero-image-2.jpg')}}') center center/cover;">
        <!-- Navigation  -->
        @include('partials._nav')
        @include('partials._banner')
